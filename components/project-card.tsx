...
export function ProjectCard({ title, description, tags, image, demoUrl, repoUrl, onViewDetails }: ProjectCardProps) {
            ...
            <div className="flex flex-col gap-2 mt-auto pt-4 border-t border-zinc-700/50">
              <div className="flex justify-between gap-2">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-zinc-400 hover:text-white hover:bg-zinc-700/50 flex-1"
                  asChild
                >
                ...
                <Button
                  size="sm"
                  className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-pink-500 hover:to-purple-500 border-0 flex-1"
                  asChild
                >
